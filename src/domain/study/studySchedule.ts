export const WEEKLY_PROBLEM_SLUGS = [
  ...
  ['valid-palindrome', 'number-of-1-bits', 'combination-sum', 'decode-ways', 'maximum-subarray'],
  [
...
/** 문제 slug에 배정된 스터디 주차를 반환하며 미등록 문제는 undefined입니다. */
export function getProblemWeek(slug: string): number | undefined {
  return problemWeekBySlug.get(slug);
}

/** 문제 slug에 연결된 공식 이슈 번호를 반환하며 미등록 문제는 undefined입니다. */
