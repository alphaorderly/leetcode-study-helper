...
import {
  ...
  extractAnswerUrl,
  normalizeAnswerUrl,
} from '../../../../src/domain/problems/answerLinks';
...
describe('answer links', () => {
  ...
  it('normalizes only supported HTTPS Algodale problem URLs', () => {
    expect(normalizeAnswerUrl('https://www.algodale.com/problems/two-sum')).toBe(
      'https://www.algodale.com/problems/two-sum',
    );
    expect(normalizeAnswerUrl('https://www.algodale.com:444/problems/two-sum/')).toBeUndefined();
  });
